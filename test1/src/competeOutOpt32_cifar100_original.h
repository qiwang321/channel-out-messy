...
void assignOpt() {
	...
	opt1.weightPath.assign("/scratch0/qwang37/weights_10_17_competeOut_cifar100_original");
	...
	opt1.momIncFactor = 0.004;
	opt1.lrMinRate = 0.05;
	opt1.momMaxRate = 1.8;

	opt1.keepStartRate = 0.4;
	opt1.keepEndRate = 0.7;
	opt1.keepIncRate = 0.001;
	...
	opt4.maxOutPoolSize = 2;
	opt4.maxOutPoolStride = 2;
	opt4.numGroups = (opt4.numFilters/opt4.outX/opt4.outX - 1)/ opt4.maxOutPoolStride + 2;
