...
void assignOpt() {
	...
	opt1.dataPath.assign("/scratch0/qwang37/cifar100_50");
	opt1.weightPath.assign("/scratch0/qwang37/cifar100_50/maxout");
	opt1.exp.assign("cifar100");
	// weight regularization
	opt1.maxNorm = 0.9;
	strcpy(opt1.lrDecayType, "exponential");
	opt1.lrStartScale = 1.0;
	opt1.lrDecayFactor = 0.975;
	opt1.lrMinRate = 0.01;
