...
void assignOpt() {
	...
	opt1.weightPath.assign("/scratch0/qwang37/weights_10_20_competeOut_cifar100");
	opt1.exp.assign("cifar100");
	// weight regularization
	opt1.maxNorm = 1.0;
	strcpy(opt1.lrDecayType, "exponential");
	strcpy(opt1.momIncType, "linear");
	opt1.lrStartScale = 3.0;
	opt1.momStartScale = 1.0;
	opt1.lrDecayFactor = 0.94;
