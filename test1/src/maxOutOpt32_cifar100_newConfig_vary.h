...
void assignOpt() {
	...
	opt1.dataPath.assign("/scratch0/qwang37/cifar100");
	opt1.weightPath.assign("/scratch0/qwang37/weights_cifar100_10_16_maxout");
	opt1.exp.assign("cifar100");
	// weight regularization
	opt1.maxNorm = 0.9;
	strcpy(opt1.lrDecayType, "exponential");
	opt1.lrStartScale = 0.7;
	opt1.lrDecayFactor = 0.96;
	opt1.lrMinRate = 0.03;
	strcpy(opt1.momIncType, "linear");
	opt1.momStartScale = 1.0;
	opt1.momIncFactor = 0.0008;
	opt1.momMaxRate = 1.2;
	...
	opt2.patchSize = 8;
	opt2.numChannels = opt1.numGroups;
	...
	opt3.patchSize = 5;
	opt3.numChannels = opt2.numGroups;
	...
	//maxout
	opt3.maxOutPoolSize = 2;
	opt3.maxOutPoolStride = 2;
	...
	opt4.patchSize = 3;
	opt4.numChannels = opt3.numGroups;
	opt4.numVis = opt4.imSize * opt4.imSize * opt4.numChannels;
	...
	opt4.maxOutPoolSize = 5;
	opt4.maxOutPoolStride = 5;
	...
	optTop.numFilters = opt1.labelSize; // classification nodes
