...
void assignOpt() {
	...
	opt1.patchNum = 2000000;
	opt1.batchSize_pre = 1024;
	opt1.batchNum_pre = opt1.patchNum / opt1.batchSize_pre;
	opt1.numEpochs_pre = 100;
	opt1.initstv_pre = 0.01;
	opt1.mom_pre = 0.0;
	opt1.lrW_pre = 0.001;
	opt1.lrB_pre = 0.002;
	opt1.weightDecay_pre = 0.000;
	strcpy(opt1.neuronType_pre, "relu");
	// side parameters
	...
	// pretraining parameters
	opt2.patchNum = 200000;
	opt2.batchSize_pre = 1024;
	opt2.batchNum_pre = opt2.patchNum / opt1.batchSize_pre;
	opt2.numEpochs_pre = 100;
	opt2.initstv_pre = opt1.initstv_pre;
	opt2.mom_pre = opt1.mom_pre;
	opt2.lrW_pre = opt1.lrW_pre;
	opt2.lrB_pre = opt1.lrB_pre;
	opt2.weightDecay_pre = opt1.weightDecay_pre;
	strcpy(opt2.neuronType_pre, "relu");
	// side parameters
	...
	// pretraining parameters
	opt3.patchNum = 20000;
	opt3.batchSize_pre = 1024;
	opt3.batchNum_pre = opt3.patchNum / opt1.batchSize_pre;
	opt3.numEpochs_pre = 100;
	opt3.initstv_pre = 0.01;
	opt3.mom_pre = opt1.mom_pre;
	opt3.lrW_pre = 0.0001;
	opt3.lrB_pre = 0.0001;
	opt3.weightDecay_pre = opt1.weightDecay_pre;
	strcpy(opt3.neuronType_pre, "relu");
	// side parameters
	...
	// pretraining parameters
	opt4.patchNum = 20000;
	opt4.batchSize_pre = 1024;
	opt4.batchNum_pre = opt4.patchNum / opt1.batchSize_pre;
	opt4.numEpochs_pre = 100;
	opt4.initstv_pre = 0.01;
	opt4.mom_pre = opt1.mom_pre;
	opt4.lrW_pre = 0.0001;
	opt4.lrB_pre = 0.0001;
	opt4.weightDecay_pre = opt1.weightDecay_pre;
	strcpy(opt4.neuronType_pre, "relu");
	// side parameters
