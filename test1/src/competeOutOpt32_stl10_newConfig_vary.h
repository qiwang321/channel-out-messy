...
void assignOpt() {
	...
	opt1.dataPath.assign("/scratch0/qwang37/stl10_32x32");
	opt1.weightPath.assign("/scratch0/qwang37/weights_stl10_10_13_good");
	opt1.exp.assign("stl10");
