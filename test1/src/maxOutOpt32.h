...
void assignOpt() {
	...
	opt1.weightPath.assign("/scratch0/qwang37/weights_cifar100");
	opt1.exp.assign("cifar10");
	// weight regularization
	opt1.maxNorm = 0.9f;
	opt1.endlr = 0.1f;
	opt1.endmom = 0.6f/0.5f;
	opt1.satur = 250;
	...
	opt4.numVis = opt3.poolOutX * opt3.poolOutX * opt3.numGroups;
	...
	optTop.numVis = opt4.outX * opt4.outX *opt4.numGroups;
	strcpy(optTop.neuronType, "");
	strcpy(optTop.layerType, "softmax");
	optTop.maxNorm = 1.9365f;
