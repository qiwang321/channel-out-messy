...
void assignOpt() {
	...
	opt1.weightPath.assign("/scratch0/qwang37/weights_cifar10_10_25_maxtop");
	...
	opt1.keepStartRate = 0.5;
	opt1.keepIncRate = 0.000;
	opt1.keepEndRate = 0.5;

	opt1.keepInputStartRate = 0.8;
	opt1.keepInputEndRate = 0.8;
