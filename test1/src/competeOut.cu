...
//			cout << "1->0\n";
	...
	printf("finetune_rnorm_competeOut() complete!\n");
	fprintf(pFile, "finetune_rnorm_competeOut() complete!\n");
...
void multiViewTest_competeOut() {
	////assignOpt();
	printf("starting multiViewTest_competeOut()!\n");
	fprintf(pFile, "starting multiViewTest_competeOut()!\n");
...
//			cout << "4->top\n";
	...
	printf("\ntest set precision: %f\n; objective = %f; time elapsed = %f seconds\n", cost, cost1,
			(float)(clock() - startClock)/CLOCKS_PER_SEC);
	printf("multiViewTest_competeOut() complete!\n");

	fprintf(pFile, "\ntest set precision: %f\n; objective = %f; time elapsed = %f seconds\n", cost, cost1,
			(float)(clock() - startClock)/CLOCKS_PER_SEC);
	fprintf(pFile, "multiViewTest_competeOut() complete!\n");
