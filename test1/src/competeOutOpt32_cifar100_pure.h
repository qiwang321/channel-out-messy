...
void assignOpt() {
	...
	opt1.maxOutPoolSize = 8;
	opt1.maxOutPoolStride = 8;
	opt1.numGroups = (opt1.numFilters - 1) / opt1.maxOutPoolStride + 1;
	opt1.dataPath.assign("/scratch0/qwang37/cifar100");
	opt1.weightPath.assign("/scratch0/qwang37/weights_10_2_competeOut_cifar100_pure");
	...
	//maxout
	opt2.maxOutPoolSize = 8;
	opt2.maxOutPoolStride = 8;
	...
	//maxout
	opt3.maxOutPoolSize = 8;
	opt3.maxOutPoolStride = 8;
	...
	opt4.maxOutPoolSize = 20;
	opt4.maxOutPoolStride = 20;
